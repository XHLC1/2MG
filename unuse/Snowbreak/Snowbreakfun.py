...
def startwholegame():
    ...
    time.sleep(5)
    while 1:
        if generalact.ImgFor3Cdelay1('Snowbreak\\picture\\CBJQOP_L.bmp', 0.8, 0, 0, 1920, 1080):
            break
        else:
            generalact.moveclick_1s(961, 731)
    # generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\op_jiasu.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(5)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\op_start.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(20)
    for i in range(3):
        if generalact.ImgFor3Cdelay1('Snowbreak\\picture\\CBJQ_update.bmp', 0.8, 0, 0, 1980, 1080) == 1:
            generalact.moveclick_1s(1100, 670)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\CBJQ_start.bmp', 0.9, 0, 0, 1920, 1080)
    enter()
...
def closegame():
    ...
    generalact.startup_time('C:\\Software\\op\\opstart.exe', 10)
    time.sleep(5)
    generalact.ImgShiftWhileDelay1Cdelay1('Snowbreak\\picture\\op_start.bmp', 0.9, 0, 0, 1920, 1080, 0, 66)


def enter():
    generalact.logger.info('Snowbreak.enter')
    while 1:
        if generalact.ImgReturn1For5('Snowbreak\\picture\\pick.bmp', 0.8, 0, 0, 1980, 1080) == 1:
            clickblock()
            backtomainui()
            break
        else:
...
def levelup():
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\character_levelup.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\character_levelup.bmp', 0.9, 0, 0, 1920, 1080)
...
def weaponlevel():
    ...
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\bag_weapon_level.bmp', 0.9, 0, 0, 1920, 1080)  # 3/4
...
def mission():
    ...
    # while 1:
    #     if generalact.ImgFor3Cdelay1('Snowbreak\\picture\\mission_get.bmp', 0.9, 0, 0, 1920, 1080):
    #         break
    #     else:
...
def gamepass():
    ...
    for i in range(3):
        if confirmcilckfun('Snowbreak\\picture\\gamepass_daily.bmp', 315, 575):
            generalact.ImgFor3Cdelay1('Snowbreak\\picture\\gamepass_daily.bmp', 0.9, 0, 0, 1920, 1080)
...
def friends():
    ...
    generalact.ImgWhile('Snowbreak\\picture\\friends_get.bmp', 0.9, 0, 0, 1920, 1080)
...
def payshop():
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\payshop_supply.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\payshop_supply_daily.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\payshop_supply_daily.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\payshop_buy.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\payshop_buy.bmp', 0.9, 0, 0, 1920, 1080)
    CSauto.press("ESC")
    backtohome()
    backtomainui()
...
def shop():
    ...
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\shop.bmp', 0.9, 0, 0, 1920, 1080)  # 3/4
...
def battle():
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\battle_fragment.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\picture\\battle_fragment.bmp', 0.9, 0, 0, 1920, 1080)
...
def battle_JSNJ():  # 精神拟镜
    if generalact.firstDayOfWeek5():
        ...
        generalact.moveclick_1s(1715, 517)
        generalact.ImgWhileDelay1Cdelay1('Snowbreak\\picture\\TBPQ.bmp', 0.9, 0, 0, 1920, 1080)
        generalact.ImgShiftWhileDelay1Cdelay1('Snowbreak\\picture\\TBPQ_JSNJ.bmp', 0.9, 0, 0, 1920, 1080, 0, -200)
        generalact.ImgShiftFor3Cdelay1('Snowbreak\\picture\\TBPQ_JSNJ.bmp', 0.9, 0, 0, 1920, 1080, 0, -200)
        for i in range(4):
...
def confirmcilck(imgstr, x, y):
    while 1:
        if generalact.ImgFor3Cdelay1(imgstr, 0.9, 0, 0, 1920, 1080):
            break
        else:
            generalact.moveclick_1s(x, y)
...
def huodong2_2():  # 碧水假日
    ...
    time.sleep(1)
    generalact.ImgFor3Cdelay1('Snowbreak\\huodong\\2_2\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\huodong\\2_2\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\huodong\\2_2\\6.bmp', 0.9, 0, 0, 1920, 1080)
...
def huodong2_1():  # 极夜行动
    ...
    time.sleep(1)
    generalact.ImgFor3Cdelay1('Snowbreak\\huodong\\2_1\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\huodong\\2_1\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.ImgFor3Cdelay1('Snowbreak\\huodong\\2_1\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.moveclick_1s(1488, 1006)  # 速战
    generalact.moveclick_1s(1288, 717)
    generalact.moveclick_1s(1228, 844)
    CSauto.press("ESC")
...
def huodong2_0():  # 空都演绎
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\huodong\\2_0\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.moveclick_1s(1488, 1006)  # 速战
    generalact.moveclick_1s(1288, 717)
    generalact.moveclick_1s(1228, 844)
    CSauto.press("ESC")
...
def huodong1_8():  # 素影遗痕
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\huodong\\1_8\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.moveclick_1s(1488, 1006)  # 速战
    generalact.moveclick_1s(1288, 717)
    generalact.moveclick_1s(1228, 844)
    CSauto.press("ESC")
...
def huodong1_7():  # 素影遗痕
    ...
    generalact.ImgWhileDelay1Cdelay1('Snowbreak\\huodong\\1_7\\6.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.moveclick_1s(1488, 1006)  # 速战
    generalact.moveclick_1s(1288, 717)
    generalact.moveclick_1s(1228, 844)
    CSauto.press("ESC")
