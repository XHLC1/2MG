...
def enter1999fun():
    ...
    generalact.imgcorrdinatefunenter('RE1999\\RE1999.bmp', 0.9, 0, 0, 1920, 1080, 0, -40)
    # generalact.moveclick_3s(1283, 328)  # 1-4
    time.sleep(15)
    generalact.imgcorrdinatefun3('RE1999\\download.bmp', 0.8, 0, 0, 1920, 1080)
    backtomainuienter()
...
def shopM():
    if generalact.firstDayOfMonth():
        ...
        generalact.imgcorrdinatefunde1('RE1999\\shop_pawnshop.bmp', 0.8, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L1.bmp', 0.9, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L2.bmp', 0.9, 0, 0, 1920, 1080)
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L_1.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L_2.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L_3.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_pawnshop_L_4.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        #############################################碎片叙事############################################################
        generalact.imgcorrdinatefunde1('RE1999\\shop_frameshop.bmp', 0.8, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_P1.bmp', 0.9, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_P2.bmp', 0.9, 0, 0, 1920, 1080)
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_P_1.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        while 1:
            if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_P_2.bmp', 0.9, 0, 0, 1920, 1080):
                shopbuy()
                break
            else:
                generalact.dragmouse(1090, 900, 1090, 600)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_D1.bmp', 0.9, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_D2.bmp', 0.9, 0, 0, 1920, 1080)
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_D_1.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_D_1.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        if generalact.imgcorrdinatefunclickcount3('RE1999\\shop_frameshop_D_2.bmp', 0.9, 0, 0, 1920, 1080):
            shopbuy()
        #############################################碎片叙事############################################################
        backtomainui()
...
def shopbuy():
    ...
    generalact.imgcorrdinatefun('RE1999\\shop_buy.bmp', 0.8, 0, 0, 1920, 1080)
    clickblock()
...
def willanalysis():
    ...
    generalact.imgcorrdinatefunde1('RE1999\\resource.bmp', 0.8, 0, 0, 1920, 1080)
...
def poussiere(huodongflag, resourceflag):
    ...
    if huodongflag:
        ...
        if resourceflag == 1:
            generalact.moveclick_1s(1686, 525)  # 入场
            generalact.imgcorrdinatefunde1('RE1999\\resource.bmp', 0.8, 0, 0, 1920, 1080)
            generalact.imgcorrdinatefunde1('RE1999\\resource_porssiere.bmp', 0.8, 0, 0, 1920, 1080)
            generalact.moveclick_1s(654, 899)
            generalact.moveclick_1s(1467, 920)  # 开始行动
            batconfirm4()
            battlevectory()
        ...
        if resourceflag == 2:
            generalact.moveclick_1s(1686, 525)  # 入场
            generalact.imgcorrdinatefunde1('RE1999\\resource.bmp', 0.8, 0, 0, 1920, 1080)
            generalact.imgcorrdinatefunde1('RE1999\\resource_mintage.bmp', 0.8, 0, 0, 1920, 1080)
            generalact.moveclick_1s(654, 899)
            generalact.moveclick_1s(1467, 920)  # 开始行动
            batconfirm4()
            battlevectory()
        ...
        if resourceflag == 3:
            ...
            generalact.imgcorrdinatefunde1('RE1999\\resource_analy.bmp', 0.8, 0, 0, 1920, 1080)
            generalact.moveclick_1s(654, 899)
            generalact.moveclick_1s(1467, 920)  # 开始行动
            batconfirm4()
            battlevectory()
...
def misihai():
    if generalact.firstDayOfWeek():
        generalact.moveclick_1s(1686, 525)  # 入场
        generalact.imgcorrdinatefunde1('RE1999\\yuzhongxuanxiang.bmp', 0.8, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunde1('RE1999\\yuzhongxuanxiang_misihai.bmp', 0.8, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunwhile('RE1999\\yuzhongxuanxiang_misihai_skip.bmp', 0.8, 0, 0, 1920, 1080)
        time.sleep(3)
        generalact.imgcorrdinatefunde1('RE1999\\yuzhongxuanxiang_misihai_skip.bmp', 0.8, 0, 0, 1920, 1080)
...
def somnambulism():
    ...
    if generalact.firstDayOfWeek():
        generalact.moveclick_1s(1686, 525)  # 入场
        generalact.imgcorrdinatefunde1('RE1999\\resource.bmp', 0.8, 0, 0, 1920, 1080)
        generalact.imgcorrdinatefunde1('RE1999\\resource_somnambulism.bmp', 0.8, 0, 0, 1920, 1080)
        clickblock()
...
def mission():
    ...
    generalact.imgcorrdinatefunde1('RE1999\\dailymission.bmp', 0.9, 0, 0, 1920, 1080)
...
def batconfirm4():
    generalact.imgcorrdinatefunwhile('RE1999\\energy.bmp', 0.9, 0, 0, 1920, 1080)
    if generalact.imgcorrdinatefuncount3('RE1999\\replay.bmp', 0.9, 590, 151, 1371, 868) == 1:
...
def batconfirm2():
    generalact.imgcorrdinatefunwhile('RE1999\\goal.bmp', 0.9, 0, 0, 1920, 1080)
    if generalact.imgcorrdinatefuncount3('RE1999\\replay.bmp', 0.9, 590, 151, 1371, 868) == 1:
        generalact.moveclick_1s(1258, 988)
...
def backtomainui():
    n = 0
    while 1:
        if generalact.imgcorrdinatefuncount('RE1999\\me.bmp', 0.7, 590, 151, 1371, 868) == 1:
            back3()
            break
        else:
            n += 1
...
def backtomainuienter():
    n = 0
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\me.bmp', 0.7, 590, 151, 1371, 868) == 1:
            back3()
            break
        else:
            # break
            ...
            n += 1
            if n >= 80:
                generalact.imgcorrdinatefunshiftclickcount3('RE1999\\RE1999.bmp', 0.9, 0, 0, 1920, 1080, 0, -40)
                generalact.MUMUclose1()
                generalact.MUMUclose1()
                generalact.imgcorrdinatefunenter('RE1999\\RE1999.bmp', 0.9, 0, 0, 1920, 1080, 0, -40)
                time.sleep(15)
...
def battlevectory():
    generalact.imgcorrdinatefun('RE1999\\vectory.bmp', 0.9, 1145, 130, 1610, 300)
    back1()
    back1()
    clickblock()
...
def huodong2_5():  # 唐人街影话
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE2.5\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(5)
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE2.5\\18.bmp', 0.8, 0, 0, 1920, 1080):
            break
        else:
            count += 1
            if count < 12:
...
def huodong2_4():  # 东区黎明
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE2.4\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(5)
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE2.4\\18.bmp', 0.8, 0, 0, 1920, 1080):
            break
        else:
            count += 1
            if count < 12:
...
def huodong2_3():  # 东区黎明
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE2.3\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(5)
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE2.3\\18.bmp', 0.8, 0, 0, 1920, 1080):
            break
        else:
            count += 1
            if count < 8:
...
def huodong2_1():  # 77号往事
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE2.1\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(5)
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE2.1\\18.bmp', 0.8, 0, 0, 1920, 1080):
            break
        else:
            count += 1
            if count < 8:
...
def huodong2_0():  # 飞驰，明日之城
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE2.0\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(3)
    while 1:
        if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE2.0\\18.bmp', 0.9, 0, 0, 1920, 1080):
            break
        else:
            generalact.dragmouse(1720, 915, 165, 895)
            time.sleep(1)
...
def huodong1_7():  # 再见，来亚什基
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.7\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    time.sleep(3)
    if generalact.imgcorrdinatefunclickcount3('RE1999\\huodong\\RE1.7\\16.bmp', 0.9, 0, 0, 1920, 1080):
        pass
    else:
...
def huodong1_6():
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.6\\enter.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.6\\19.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.rangeclick01(5, 1800, 400)
    generalact.moveclick_1s(1545, 946)
    batconfirm4()
    battlevectory()
...
def huodong1_5():
    ...
    generalact.moveclick_1s(1550, 355)  # 入场
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.5\\RE1.5_Lfire.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.5\\RE1.5_com_13.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.rangeclick01(5, 1800, 400)
    generalact.moveclick_1s(1545, 946)
    batconfirm4()
    battlevectory()
...
def huodong1_4_37():
    ...
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.4_qishi.bmp', 0.9, 0, 0, 1920, 1080)
...
def huodong1_2():
    ...
    generalact.imgcorrdinatefunde1('RE1999\\huodong\\RE1.2\\17.bmp', 0.9, 0, 0, 1920, 1080)
    generalact.rangeclick01(5, 1800, 400)
    generalact.moveclick_1s(1545, 946)
    batconfirm4()
    battlevectory()
