...
if __name__ == '__main__':
    ...
    insert_into_playlist(playList, r'C:\Users\XHL\Desktop\wav\「Memento Mori手游」英文版抒情诗合集（1080P⧸320K） p01 A.A. Ⅶ. THE '
                                   r'RUST (Full Ver.).wav')
    insert_into_playlist(playList, r'C:\Users\XHL\Desktop\wav\「Memento Mori手游」英文版抒情诗合集（1080P⧸320K） p02 A.A. Ⅶ. THE '
                                   r'RUST (Full Ver.).wav')
    insert_into_playlist(playList, r'C:\Users\XHL\Desktop\wav\「Memento Mori手游」英文版抒情诗合集（1080P⧸320K） p03 Natasha X. THE '
